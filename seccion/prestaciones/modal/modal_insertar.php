                            ...
                            <form action="seccion/directorio/guardar_directorio.php" method="post" id="insertar-directorio">
                                <div class="row justify-content-center g-3">
                                    <div class="row justify-content-center g-3">
                                        <div class="col-9 col-sm-5 mb-3">
                                            ...
                                            <input style="text-align: center;" type="text" class="form-control" name="puestoDirectorio" required>
                                        </div>
                                    </div>
                                    <div class="col-9 col-sm-5 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nombre_directorio" id="insert-nombre_directorio" aria-label="Nombre_directorio" required>
                                    </div>
                                    <div class="col-9 col-sm-5 mb-3">
                                        <label for="apellidos_directorio" class="form-label">Apellidos</label>
                                        <input type="text" class="form-control" name="apellidos_directorio" id="insert-apellidos_directorio" aria-label="apellidos_directorio" required>
                                    </div>
                                </div>
                                <div class="row justify-content-center g-3">
                                    <div class="col-9 col-sm-5 mb-3 mb-3">
                                        <label for="correo_directorio" class="form-label">Correo</label>
                                        <input type="email" class="form-control" name="correo_directorio" id="insert-correo_directorio" aria-describedby="correo_directorio" required>
                                    </div>
                                    <div class="col-9 col-sm-5 mb-3 mb-3">
                                        <label for="oficina_directorio" class="form-label">Oficina</label>
                                        <select name="oficina_directorio" id="insert-oficina_directorio" class="form-select" required>
                                ...
                                <div class="row justify-content-center g-3">
                                    <div class="col-9 col-sm-5 mb-3">
                                        ...
                                        <input type="tel" name="telefono_directorio" class="form-control" id="insert-telefono_directorio" aria-label="telefono_directorio" required>
                                    </div>
                                    <div class="col-9 col-sm-5 mb-3">
                                        <label for="extension_directorio" class="form-label">Extensión</label>
                                        <input type="text" name="extension_directorio" class="form-control" id="insert-extension_directorio" aria-label="extension_directorio" required>
                                    </div>
                                </div>

                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="body_tabla_sanciones celda_tabla_sanciones">
                                            ...
                                            <td style='text-align:center; font-size: 14px;'><?php echo $row['ts_idEstado'] ?>
                                            </td>
                                            <td style='text-align:center;font-size: 14px;'>
                                                <?php echo date('d/m/y', strtotime($row['ts_fecha_real_baja'])); ?></td>
                                            <td style='text-align:center;font-size: 14px;'><?php echo $row['NIFDNI'] ?></td>
                                            <td style='text-align:center;font-size: 14px;'><?php echo $row['APELLIDOSNOMBRE'] ?>
                                            </td>
                                            <td style='text-align:center;font-size: 14px;'>
                                                <?php echo $row['ts_varias_infracciones'] ?></td>
                                            <td style='text-align:center;font-size: 14px;'><?php echo $row['ts_tipo_sancion'] ?>
                                            </td>
                                            <td style='text-align:center;font-size: 14px;'>
                                            ...
                                            <td style='text-align:center;font-size: 14px;'>
                                                <?php echo date('d/m/y', strtotime($row['ts_se_puede_resolver'])) ?></td>
                                            <td style='text-align:center;font-size: 14px;'><?php echo $row['ts_estimada'] ?>
                                            </td>
                                            <td style='text-align:center;font-size: 14px;'>
                                                <?php echo $row['ts_control_nomina'] ?></td>
                                            <td style='text-align:center;font-size: 14px;'><?php echo $row['ts_motivo'] ?></td>
                                            <?php
                                            if ($_SESSION["sanciones"] === "editar") {
                                            ?>
                                                <td style='text-align:center;'> <button id='btn-edit-directorio' class='edit-table' data-bs-toggle='modal' data-bs-target='#modal-edit-directorio<?php echo $row['id']; ?>'><i class='bi bi-pencil-square'></i></button>

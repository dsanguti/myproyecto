                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Agregar Persona al Directorio</h5>
                            ...
                            <form action="./guardar_directorio.php" method="post" id="insertar-directorio">
                                <div class="row justify-content-center g-3">
                                    <div class="col-9 col-sm-5 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="insert-nombre_directorio" aria-label="Nombre_directorio">
                                    </div>
                                    <div class="col-9 col-sm-5 mb-3">
                                ...
                                <div class="row justify-content-center g-3">
                                    <div class="col-9 col-sm-5 mb-3">
                                        ...
                                        <input type="text" name="telefono_directorio" class="form-control" id="insert-telefono_directorio" aria-label="telefono_directorio">
                                    </div>
                                    <div class="col-9 col-sm-5 mb-3">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="guardar_directorio" id="btn-edit-guardar" class="btn btn-primary">Guardar</button>
                        </div>
                    </div>
                </div>
            </div>

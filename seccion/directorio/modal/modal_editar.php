<div class="container-xl">
    <div class="row">
        <div class="col">
            ...
            <!-- Modal -->
            <div class="modal fade modal-lg" id="modal-edit-directorio<?php echo $row['id']; ?>" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="seccion/directorio/edit.php?id=<?php echo $row['id']; ?>" method="post"
                                id="form-editar-directorio">
                                ...
                                <div class="row justify-content-center g-3">
                                    <div class="col-9 col-sm-5 mb-3">
                                        ...
                                        <input type="hidden" name="id_directorio" class="form-control"
                                            value="<?php echo $row['id']; ?>" id="edit-id" readonly

<div class="container-xl">
    <div class="row">
        <div class="col">
            ...
            <!-- Modal -->
            <div class="modal fade modal-lg" id="insertarModal_inv" tabindex="-1" aria-labelledby="insertarModal_inv" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-add">
                            <h5 class="modal-title" id="exampleModalLabel"> <i class="bi bi-person-add"></i>
                                Agregar artículo en inventario COE</h5>
                                ...
                                <div class="row justify-content-center g-3">
                                    <div class="row justify-content-center g-3">
                                        <div class="col-9 col-sm-5 mb-3">
                                            ...
                                            <input style="text-align: center;" type="text" class="form-control" name="nombrePC" required>
                                        </div>
                                        <div class="col-9 col-sm-5 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="apellidoPC" id="insert-apellidoPC" aria-label="apellidoPC" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-center g-3">
                                    <div class="row justify-content-center g-3">
                                        <div class="col-9 col-sm-5 mb-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="usuarioPC" id="insert-usuarioPC" aria-label="usuarioPC" required>
                                        </div>
                                        <div class="col-9 col-sm-5 mb-3">
                                            <label for="perfilPC" class="form-label">Perfil</label>
                                            <input type="text" class="form-control" name="perfilPC" id="insert-perfilPC" aria-label="perfilPC" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row justify-content-center g-3">
                                    <div class="row justify-content-center g-3">
                                        <div class="col-9 col-sm-5 mb-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="clavePC" id="insert-clavePC" aria-label="clavePC" required>
                                        </div>
                                        <div class="col-9 col-sm-5 mb-3 mb-3">
                                ...
                                <div class="row justify-content-center g-3">
                                    <div class="row justify-content-center g-3">
                                        <div class="col-9 col-sm-5 mb-3 mb-3">
                                            ...
                                            <select name="directorioPC" id="insert-directorioPC" class="form-select" required>
                                                <option selected>Seleccionar...</option>
                                        ...
                                        <div class="col-9 col-sm-5 mb-3 mb-3">
                                            ...
                                            <select name="inventarioPC" id="insert-inventarioPC" class="form-select" required>
                                                <option selected>Seleccionar...</option>
                                                <option>editar</option>
                                                <option>consulta</option>
                                            </select>

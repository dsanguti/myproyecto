                                ...
                                <tbody>
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        <tr class="celda_tabla_directorio">
                                            ...
                                            ?>
                                                <td class="buscar_datos" style='text-align:center;'>
                                                    <button id='btn-edit-inventario' class='edit-table' data-bs-toggle='modal' data-bs-target='#modal-edit-inventario<?php echo $row['id']; ?>'>
                                                        <i class='bi bi-pencil-square'></i>
                                                    </button>
                                                </td>
                                                <td class="buscar_datos" style='text-align:center;'>
                                                    <button id='btn-del-inventario' class='del-table' data-bs-toggle='modal' data-bs-target='#modal-del-inventario<?php echo $row['id']; ?>'>

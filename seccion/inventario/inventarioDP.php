...
<div class="container-fluid">
    <div style="margin:0px; padding:0px;" class="row">
        ...
        <div class="col-md-12 titulo_seccion" style="padding-top:22px;padding-bottom:40px; text-align: center;">
            <h2>Inventario de Dirección Provincial</h2>
        </div>
                ...
                <div class="col-6 d-flex justify-content-end">
                    <form class="d-flex flex-row" role="search">
                        <div class="input-container-search">
                            <input style="max-width:450px;" class="form-control me-2 input-dir-search" type="search" placeholder="Buscar en inventario DP" id="buscarDirectorio" aria-label="Search">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div id="tabla_inventario_COE">
                        ...
                        $result = $conn->query("SELECT * FROM inventario where centro='DP'");
                            ...
                            <table class="table table-striped table-hover" id="table-directorio">
                                ...
                                <thead style="position: sticky;top:0;">
                                    <tr>
                                        ...
                                        <th style="background-color:#0f6ba5;color: #fff;text-align:center;" scope="col">
                                            F.Inicio Mto.</th>
                                        <th style="width:96px; background-color:#0f6ba5;color: #fff;text-align:center;" scope="col">
                                            F.Fin Mto.</th>
                                        <th style="background-color:#0f6ba5;color: #fff;text-align:center;" scope="col">
                                            Proveedor</th>
